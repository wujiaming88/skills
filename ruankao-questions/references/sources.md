...
## 源0: awesome-ruankao 本地资料库 ⭐⭐⭐（最高优先）

- **路径**: `/root/.openclaw/workspace/project/awesome-ruankao`
- **GitHub**: `wujiaming88/awesome-ruankao`
- **覆盖**: 9个科目，2020-2025年，67个Markdown文件 + 1个PDF
- **特点**: 内容已验证、Markdown格式可直接读取、含完整答案解析
- **访问方式**: `read` 工具直接读取本地文件
...
│   ├── 2023年下半年/       综合知识+案例分析+论文
│   ├── 2022年下半年/       综合知识+案例分析+论文
│   ├── 2021年下半年/       综合知识+案例分析+论文
│   └── 2020年下半年/       综合知识+案例分析+论文
├── 信息系统项目管理师/      2024(两批次)+案例分析
├── 系统分析师/              2023-2024
├── 网络规划设计师/          2023-2024
├── 软件设计师/              2024(上下)
├── 网络工程师/              2023-2024(4学期)
├── 信息安全工程师/          2023-2024(仅下半年)
├── 数据库系统工程师/        2023-2024
...
### 配套资源
```
docs/备考攻略/     学习路线、提分技巧、机考指南
论文/              万能模板、高频主题、3篇完整范文
案例分析/          解题框架、质量属性专题
模拟题/            架构师20题、项管师20题
资源/              教材书单、视频课程、工具推荐
docs/政策与考试指南/  2025-2026政策、机考改革、国际互认
```
