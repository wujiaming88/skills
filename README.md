...
| [doubao-seedream-5](./doubao-seedream-5/SKILL.md) | 调用火山方舟官方 Seedream 5.0 Pro API 进行文生图、多图参考编辑、透明图编辑和图层拆分。 | Python 3.10+ 与 Pillow，uv 可选；密钥从 `SEEDREAM_API_KEY` 读取；透明编辑要求输入已有透明通道。 |
